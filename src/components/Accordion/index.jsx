    ...
    <div className="accordion">
      <div className="accordion__content">
        <div className="accordion__content-title">
          <h4>
            <strong>
              Kiến thức về thiết kế website, Photoshop, Figma &amp; Chrome Dev
              Tool
            </strong>
          </h4>
        </div>
        ...
        >
          ...
          <div className="item --lock">
            <p>
              ...
              <span>
                Đo đạc text, size, màu sắc, font chữ, resize, crop, export hình
                từ Photoshop &amp; Figma
              </span>
            </p>
          </div>
        ...
        <div className="accordion__content-text --transparent">
          ...
          <div className="item --lock">
            <p>
              ...
              <span>
                Phân tích bản thiết kế và hướng dẫn thực hành code HTML cho dự
                án
              </span>
            </p>
          </div>
      ...
      <div className="accordion__content">
        <div className="accordion__content-title">
          <h4>
            <strong>
              Javascript DOM, BOM, Javascript nâng cao và các thư viện JS thông
              dụng
            </strong>
          </h4>
        </div>
      ...
      <div className="accordion__content">
        <div className="accordion__content-title">
          <h4>
            <strong>Báo cáo, đánh giá &amp; góp ý tối ưu dự án Wooder</strong>
          </h4>
        </div>
        <div className="accordion__content-text --transparent">
          <div className="item --lock">
      ...
      <div className="accordion__content">
        <div className="accordion__content-title">
          <h4>
            <strong>Báo cáo, đánh giá &amp; góp ý tối ưu Web Responsive</strong>
          </h4>
        </div>
        <div className="accordion__content-text --transparent">
          <div className="item --lock">
